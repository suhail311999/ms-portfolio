...
export default function App() {
  ...
  return (
    <div style={{ minHeight: '100vh' }}>
        ...
        <div style={S.sectionPad}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', maxWidth: '900px' }}>
            <div>
              ...
              {[['📧', 'Email', 'suhailhaq31@gmail.com'], ['💼', 'LinkedIn', 'linkedin.com/in/mohamed-suhail-3105s'], ['📍', 'Location', 'Cuddalore, Tamil Nadu, India']].map(([ico, label, val]) => (
      ...
      {/* ── FOOTER ── */}
      <footer className="sans" style={{ background: '#080c14', borderTop: '1px solid rgba(201,162,39,0.12)', padding: '24px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
        <div style={{ color: '#444', fontSize: '13px' }}>© 2025 Mohamed Suhail · IT Infrastructure & Administration · Cuddalore</div>
        <div style={{ color: '#c9a227', fontSize: '13px', letterSpacing: '1px' }}>Built with precision & purpose</div>
      </footer>
